...
*/
  ...
  function Fa(a, b, c, d) {
    try {
      var e = b.call(a.f.h, c);
      if (!(e instanceof Object))
        throw new TypeError("Iterator result " + e + " is not an object");
      if (!e.done) return (a.f.l = !1), e;
      var f = e.value;
    } catch (g) {
      return (a.f.h = null), ta(a.f, g), Ga(a);
    }
    a.f.h = null;
    d.call(a.f, f);
    return Ga(a);
  ...
  function Ga(a) {
    for (; a.f.g; )
      try {
        var b = a.g(a.f);
        if (b) return (a.f.l = !1), { value: b.value, done: !1 };
      } catch (c) {
        (a.f.o = void 0), ta(a.f, c);
      }
    a.f.l = !1;
    if (a.f.f) {
      b = a.f.f;
  ...
  function Ha(a) {
    this.next = function (b) {
      sa(a.f);
      a.f.h ? (b = Fa(a, a.f.h.next, b, a.f.m)) : (a.f.m(b), (b = Ga(a)));
      return b;
    };
    this["throw"] = function (b) {
      sa(a.f);
      a.f.h ? (b = Fa(a, a.f.h["throw"], b, a.f.m)) : (ta(a.f, b), (b = Ga(a)));
      return b;
    };
  ...
  t("Promise", function (a) {
    ...
    b.prototype.i = function () {
      ...
      var h = this,
        k = !1;
      return { resolve: g(this.ga), reject: g(this.j) };
    };
    ...
    b.prototype.va = function (g) {
      ...
      "function" == typeof h ? this.ja(h, g) : this.l(g);
    };
    ...
    b.prototype.ha = function () {
      ...
      e(function () {
        if (g.G()) {
          var h = da.console;
          "undefined" !== typeof h && h.error(g.h);
        }
      }, 1);
    };
    ...
    b.prototype.v = function () {
      if (null != this.g) {
        for (var g = 0; g < this.g.length; ++g) f.g(this.g[g]);
        this.g = null;
      }
    };
    var f = new c();
    ...
    b.prototype.J = function (g, h) {
      ...
      var l = this;
      null == this.g ? f.g(k) : this.g.push(k);
      this.m = !0;
    };
    b.resolve = d;
    b.reject = function (g) {
  ...
  t("WeakMap", function (a) {
    ...
    b.prototype.get = function (k) {
      return d(k) && x(k, g) ? k[g][this.f] : void 0;
    };
    b.prototype.has = function (k) {
      return d(k) && x(k, g) && x(k[g], this.f);
    };
    b.prototype["delete"] = function (k) {
      return d(k) && x(k, g) && x(k[g], this.f) ? delete k[g][this.f] : !1;
    };
    return b;
  });
  t("Map", function (a) {
      ...
      if (m && x(h.g, l))
        for (var n = 0; n < m.length; n++) {
          ...
          if ((k !== k && r.key !== r.key) || k === r.key)
            return { id: l, list: m, index: n, s: r };
        }
      return { id: l, list: m, index: -1, s: void 0 };
    }
    function e(h) {
      this.g = {};
      this.f = b();
    ...
    e.prototype["delete"] = function (h) {
      ...
      return h.s && h.list
        ? (h.list.splice(h.index, 1),
          h.list.length || delete this.g[h.id],
          (h.s.previous.next = h.s.next),
          (h.s.next.previous = h.s.previous),
          (h.s.head = null),
          this.size--,
          !0)
        : !1;
  ...
  var Jb = G("Opera"),
    ...
    Mb =
      G("Gecko") &&
      !(-1 != F.toLowerCase().indexOf("webkit") && !G("Edge")) &&
      !(G("Trident") || G("MSIE")) &&
      !G("Edge"),
    Nb = -1 != F.toLowerCase().indexOf("webkit") && !G("Edge");
  function Ob() {
    var a = y.document;
  ...
  if (y.document && Kb) {
    var cc = Ob();
    bc = cc ? cc : parseInt($b, 10) || void 0;
  } else bc = void 0;
  var dc = bc;
  var ec = (G("iPhone") && !G("iPod") && !G("iPad")) || G("iPod"),
    fc = G("iPad");
  var gc = {},
    hc = null;
  var H = window;
    ...
    if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
      ...
      if (null == c) {
        if (a.constructor && a.constructor instanceof Function) {
          ...
          else if (((c = a.constructor), kc[c])) c = kc[c];
          else {
            c = String(c);
            if (!kc[c]) {
              var f = /function\s+([^\(]+)/m.exec(c);
              kc[c] = f ? f[1] : "[Anonymous]";
            }
            c = kc[c];
          }
  ...
  p.remove = function (a, b, c) {
    ...
    this.set(a, "", { Y: 0, path: b, domain: c });
    return d;
  };
  p.isEmpty = function () {
  ...
  var nc = new mc("undefined" == typeof document ? null : document);
  function oc(a, b) {
    this.width = a;
    this.height = b;
  }
  ...
  function pc(a, b) {
    ...
    if (a) {
      ...
      for (c = d = 0; (e = f[c]); c++) {
        var h = e.className,
          k;
        if ((k = "function" == typeof h.split)) k = 0 <= bb(h.split(/\s+/), a);
        k && (g[d++] = e);
      }
      g.length = d;
      return g;
  ...
  function Fc() {}
  function Gc(a, b) {
    if (b !== Ec) throw Error("Bad secret");
    this.f = a;
  }
  qa(Gc, Fc);
  ...
  new Gc("about:blank", Ec);
  new Gc("about:invalid#zTSz", Ec);
  var Hc = new Date().getTime();
  function Ic(a) {
    if (!a) return "";
    a = a.split("#")[0].split("?")[0];
    a = a.toLowerCase();
  ...
  function Jc() {
    ...
    function b(n) {
      for (var r = g, q = 0; 64 > q; q += 4)
        r[q / 4] = (n[q] << 24) | (n[q + 1] << 16) | (n[q + 2] << 8) | n[q + 3];
      for (q = 16; 80 > q; q++)
        (n = r[q - 3] ^ r[q - 8] ^ r[q - 14] ^ r[q - 16]),
          (r[q] = ((n << 1) | (n >>> 31)) & 4294967295);
      n = e[0];
      var v = e[1],
        w = e[2],
        E = e[3],
      ...
      for (q = 0; 80 > q; q++) {
        if (40 > q)
          if (20 > q) {
            var fa = E ^ (v & (w ^ E));
            var Da = 1518500249;
          } else (fa = v ^ w ^ E), (Da = 1859775393);
        else
          60 > q
            ? ((fa = (v & w) | (E & (v | w))), (Da = 2400959708))
            : ((fa = v ^ w ^ E), (Da = 3395469782));
        fa =
          ((((n << 5) | (n >>> 27)) & 4294967295) + fa + Sa + Da + r[q]) &
          4294967295;
        Sa = E;
        E = w;
    ...
    function d() {
      ...
      b(f);
      for (q = r = 0; 5 > q; q++)
        for (var v = 24; 0 <= v; v -= 8) n[r++] = (e[q] >> v) & 255;
      return n;
    }
    ...
    return {
      ...
      digest: d,
      ka: function () {
        for (var n = d(), r = "", q = 0; q < n.length; q++)
          r +=
  ...
  function Mc(a) {
    var b = Ic(String(y.location.href)),
      c;
    (c = y.__SAPISID || y.__APISID || y.__OVERRIDE_SID)
      ? (c = !0)
      : ((c = new mc(document)),
        (c =
          c.get("SAPISID") ||
    ...
    if (
      ...
      return d && c && b ? [b, Kc(Ic(d), c, a || null)].join(" ") : null;
    }
    return null;
  }
  function Nc() {
  ...
  xd.prototype.update = function (a, b) {
    if (null != a) {
      ...
      for (var c = b - this.g, d = 0, e = this.l, f = this.h; d < b; ) {
        if (0 == f) for (; d <= c; ) yd(this, a, d), (d += this.g);
        if ("string" === typeof a)
          for (; d < b; ) {
  ...
  xd.prototype.digest = function () {
    ...
    56 > this.h
      ...
      : this.update(this.i, this.g - (this.h - 56));
  ...
  function Ed(a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof Ed)
        for (c = Fd(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  p.remove = function (a) {
    return Object.prototype.hasOwnProperty.call(this.h, a)
      ? (delete this.h[a],
        this.g--,
        this.i++,
        this.f.length > 2 * this.g && Gd(this),
        !0)
      : !1;
  };
  function Gd(a) {
  ...
  p.set = function (a, b) {
    Object.prototype.hasOwnProperty.call(this.h, a) ||
      (this.g++, this.f.push(a), this.i++);
    this.h[a] = b;
  };
  p.forEach = function (a, b) {
    for (var c = Fd(this), d = 0; d < c.length; d++) {
      var e = c[d],
        f = this.get(e);
      a.call(b, f, e, this);
    }
  ...
  p.B = function (a) {
    ...
    e.next = function () {
      ...
      if (b >= d.f.length) throw zd;
      var f = d.f[b++];
      return a ? f : d.h[f];
    };
    return e;
  };
  var Id = !Kb || 9 <= Number(dc),
    Jd;
  if ((Jd = Kb)) {
    var Kd;
    if (Object.prototype.hasOwnProperty.call(ac, "9")) Kd = ac["9"];
    else {
      for (
        var Ld = 0,
          Md = wb(String($b)).split("."),
          Nd = wb("9").split("."),
          Od = Math.max(Md.length, Nd.length),
          Pd = 0;
        0 == Ld && Pd < Od;
        Pd++
      ) {
        ...
        do {
          var Sd = /(\d*)(\D*)(.*)/.exec(Qd) || ["", "", "", ""],
            Td = /(\d*)(\D*)(.*)/.exec(Rd) || ["", "", "", ""];
          if (0 == Sd[0].length && 0 == Td[0].length) break;
          Ld =
            Eb(
              0 == Sd[1].length ? 0 : parseInt(Sd[1], 10),
              0 == Td[1].length ? 0 : parseInt(Td[1], 10)
            ) ||
            Eb(0 == Sd[2].length, 0 == Td[2].length) ||
            Eb(Sd[2], Td[2]);
          Qd = Sd[3];
          Rd = Td[3];
        } while (0 == Ld);
  ...
  var Ud = Jd,
    Vd = (function () {
      ...
      try {
        y.addEventListener("test", Pa, b), y.removeEventListener("test", Pa, b);
      } catch (c) {}
      return a;
    })();
  function Wd(a, b) {
  ...
  ce.prototype.add = function (a, b, c, d, e) {
    var f = a.toString();
    a = this.listeners[f];
    a || ((a = this.listeners[f] = []), this.f++);
    var g = de(a, b, d, e);
    -1 < g
      ? ((b = a[g]), c || (b.I = !1))
      : ((b = new ae(b, this.src, f, !!d, e)), (b.I = c), a.push(b));
    return b;
  };
  ce.prototype.remove = function (a, b, c, d) {
    ...
    return -1 < b
      ? (be(e[b]),
        ...
        0 == e.length && (delete this.listeners[a], this.f--),
        !0)
      : !1;
  };
  function ee(a, b) {
    ...
    c in a.listeners &&
      eb(a.listeners[c], b) &&
      (be(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.f--));
  }
  function de(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.F && f.listener == b && f.capture == !!c && f.K == d) return e;
    }
    return -1;
  }
  ...
  function ie(a, b, c, d, e) {
    if (d && d.once) je(a, b, c, d, e);
      ...
      (c = ke(c)),
        a && a[Zd]
          ? a.f.add(String(b), c, !1, A(d) ? !!d.capture : !!d, e)
          : le(a, b, c, !1, d, e);
  }
  function le(a, b, c, d, e, f) {
    if (!b) throw Error("Invalid event type");
    var g = A(e) ? !!e.capture : !!e,
      h = me(a);
    h || (a[fe] = h = new ce(a));
    c = h.add(b, c, d, g, f);
    if (!c.f) {
  ...
  function je(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (c = ke(c)),
        a && a[Zd]
          ? a.f.add(String(b), c, !0, A(d) ? !!d.capture : !!d, e)
          : le(a, b, c, !0, d, e);
  }
  function qe(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      ((d = A(d) ? !!d.capture : !!d), (c = ke(c)), a && a[Zd])
        ? a.f.remove(String(b), c, d, e)
        : a &&
          (a = me(a)) &&
  ...
  function re(a) {
    if ("number" !== typeof a && a && !a.F) {
      ...
      if (b && b[Zd]) ee(b.f, a);
        ...
        he--;
        (c = me(b))
          ? (ee(c, a), 0 == c.f && ((c.src = null), (b[fe] = null)))
          : be(a);
      }
    }
  }
    ...
    if ((a = me(a)))
      if ((b = a.listeners[b.toString()]))
        for (b = b.concat(), a = 0; a < b.length; a++) {
          var f = b[a];
          f && f.capture == c && !f.F && ((f = te(f, d)), (e = e && !1 !== f));
        }
    return e;
  }
  function te(a, b) {
  ...
  function pe(a, b) {
    ...
    if (!Id) {
      ...
      if (!(0 > c.keyCode || void 0 != c.returnValue)) {
        ...
        c = [];
        for (f = d.f; f; f = f.parentNode) c.push(f);
        f = a.type;
        for (var g = c.length - 1; !d.g && 0 <= g; g--) {
          d.f = c[g];
          var h = se(c[g], f, !0, d);
          e = e && h;
        }
        for (g = 0; !d.g && g < c.length; g++)
          (d.f = c[g]), (h = se(c[g], f, !1, d)), (e = e && h);
      }
      return e;
    }
    return te(a, new Xd(b, this));
  }
  function me(a) {
    a = a[fe];
  ...
  J.prototype.dispatchEvent = function (a) {
    ...
    if (b) {
      var c = [];
      for (var d = 1; b; b = b.j) c.push(b), ++d;
    }
    b = this.l;
    d = a.type || a;
    if ("string" === typeof a) a = new Wd(a, b);
    else if (a instanceof Wd) a.target = a.target || b;
    else {
      var e = a;
      a = new Wd(d, b);
      ub(a, e);
    ...
    e.f = new K(function (f, g) {
      ...
      e.onRejected = c
        ? function (h) {
            try {
              var k = c.call(d, h);
              void 0 === k && h instanceof Ie ? g(h) : f(k);
            } catch (l) {
              g(l);
            }
          }
  ...
  function xe(a, b, c) {
    0 == a.f &&
      ...
      De(c, a.v, a.G, a) ||
        ...
        (a.h = null),
        Ne(a),
        3 != b || c instanceof Ie || Oe(a, c)));
  }
  function De(a, b, c, d) {
    if (a instanceof K) return Me(a, Ae(b || Pa, c || null, d)), !0;
    if (a)
      try {
    ...
    if (A(a))
      try {
        var f = a.then;
        if ("function" === typeof f) return Pe(a, f, b, c, d), !0;
      } catch (g) {
        return c.call(d, g), !0;
      }
    return !1;
  ...
  K.prototype.o = function () {
    for (var a; (a = Ke(this)); ) Le(this, a, this.f, this.m);
    this.l = !1;
  };
  function Le(a, b, c, d) {
    if (3 == c && b.onRejected && !b.h) for (; a && a.j; a = a.h) a.j = !1;
    if (b.f) (b.f.h = null), Qe(b, c, d);
    else
      try {
        b.h ? b.g.call(b.context) : Qe(b, c, d);
      } catch (e) {
        Re.call(null, e);
      }
    Qc(ze, b);
  ...
  p.clear = function (a) {
    if (a) {
      var b = this.g[a];
      b && (D(b, this.O, this), delete this.g[a]);
  ...
  Ve.prototype.set = function (a, b) {
    void 0 === b ? this.f.remove(a) : this.f.set(a, we(b));
  };
  ...
  We.prototype.set = function (a, b) {
    We.A.set.call(this, a, Ye(b));
  };
  We.prototype.g = function (a) {
    a = We.A.get.call(this, a);
  ...
  Ze.prototype.set = function (a, b, c) {
    ...
    Ze.A.set.call(this, a, b);
  };
  Ze.prototype.g = function (a) {
    var b = Ze.A.g.call(this, a);
    if (b) {
      var c = b.creation,
        d = b.expiration;
  ...
  p.set = function (a, b) {
    this.f.setAttribute(gf(a), b);
    hf(this);
  };
  p.get = function (a) {
    a = this.f.getAttribute(gf(a));
    if ("string" !== typeof a && null !== a)
      throw "Storage mechanism: Invalid value was encountered";
    return a;
  };
  p.remove = function (a) {
    this.f.removeAttribute(gf(a));
    hf(this);
  };
  p.B = function (a) {
    var b = 0,
  ...
  function lf(a) {
    ...
    1 < b.length
      ? (kf[b[0]] = b[1])
      : 1 === b.length && Object.assign(kf, b[0]);
  }
  function O(a, b) {
  ...
  function tf(a) {
    ...
    try {
      if ((a = a || window.event)) {
        this.event = a;
        for (var b in a) b in sf || (this[b] = a[b]);
  ...
  tf.prototype.stopImmediatePropagation = function () {
    this.event &&
      ((this.event.cancelBubble = !0),
  ...
  B("ytEventsEventsListeners", qb);
  var uf = y.ytEventsEventsCounter || { count: 0 };
  B("ytEventsEventsCounter", uf);
  function vf(a, b, c, d) {
    d = void 0 === d ? {} : d;
    a.addEventListener &&
  ...
  function kg(a) {
    return (
      jg[a] ||
      (jg[a] = String(a).replace(/\-([a-z])/g, function (b, c) {
  ...
  var lg = {},
    ...
    ng = {};
  function og() {
    for (var a = u(mg), b = a.next(); !b.done; b = a.next()) (b = b.value), b();
  }
  function pg(a, b) {
    b || (b = document);
    var c = gb(b.getElementsByTagName("yt:" + a));
    var d = "yt-" + a;
    var e = b || document;
    d =
  ...
  function sg(a, b, c) {
    tg || ((tg = {}), yf(window, "message", Xa(a.i, a)));
    tg[c] = b;
  }
  rg.prototype.i = function (a) {
    if (
      a.origin == Q(this, "host") ||
      a.origin == Q(this, "host").replace(/^http:/, "https:")
    ) {
      try {
      ...
      if ((a = tg[b.id]))
        (a.o = !0), a.o && (D(a.m, a.V, a), (a.m.length = 0)), a.ea(b);
    }
  };
  var tg = null;
  function R(a) {
  ...
  function xg(a) {
    var b = 5e3;
    isNaN(b) && (b = void 0);
    var c = z("yt.scheduler.instance.addJob");
    c ? c(a, 0, b) : void 0 === b ? a() : zf(a, b || 0);
  }
  function yg() {}
  qa(yg, wg);
  ...
  yg.g();
  var zg = y.ytPubsubPubsubInstance || new M(),
  ...
  M.prototype.unsubscribeByKey = M.prototype.O;
  M.prototype.publish = M.prototype.M;
  M.prototype.clear = M.prototype.clear;
  B("ytPubsubPubsubInstance", zg);
  B("ytPubsubPubsubTopicToKeys", Bg);
  B("ytPubsubPubsubIsSynchronous", Cg);
  B("ytPubsubPubsubSubscribedKeys", Ag);
  var S = window,
    Dg =
      S.ytcsi && S.ytcsi.now
        ? S.ytcsi.now
  ...
  var Eg = vg("initial_gel_batch_timeout", 1e3),
    Fg = Math.pow(2, 16) - 1,
    Gg = null,
    Hg = 0,
    Ig = void 0,
    ...
    Lg = 0,
    Mg = !0,
    Ng = y.ytLoggingTransportGELQueue_ || new Map();
  B("ytLoggingTransportGELQueue_", Ng);
  var Og = y.ytLoggingTransportTokensToCttTargetIds_ || {};
  B("ytLoggingTransportTokensToCttTargetIds_", Og);
  function Pg() {
    return new K(function (a) {
      window.clearTimeout(Jg);
      window.clearTimeout(Kg);
      Kg = 0;
      Ig && Ig.isReady() ? (Qg(a), Ng.clear()) : (Rg(), a());
    });
  }
  function Rg() {
    R("web_gel_timeout_cap") && !Kg && (Kg = zf(Pg, 6e4));
    window.clearTimeout(Jg);
    var a = O("LOGGING_BATCH_TIMEOUT", vg("web_gel_debounce_ms", 1e4));
    R("shorten_initial_gel_batch_timeout") && Mg && (a = Eg);
    Jg = zf(Pg, a);
  }
  function Qg(a) {
    for (
      var b = Ig, c = Math.round(Dg()), d = Ng.size, e = u(Ng), f = e.next();
      !f.done;
      f = e.next()
    ) {
      var g = u(f.value);
  ...
  function Vg(a, b) {
    ...
    if (c) {
      ...
      !d &&
        R("web_client_counter_random_seed") &&
        (d = Math.floor((Math.random() * Fg) / 2));
      d++;
      d > Fg && (d = 1);
      lf("BATCH_CLIENT_COUNTER", d);
      ...
      Gg &&
        ...
        R("log_gel_rtt_web") &&
        (a.previousBatchInfo = {
          serializedClientEventId: Gg,
          roundtripMs: String(Hg),
        });
      Gg = c;
      Hg = 0;
    }
  ...
  var Xg = y.ytLoggingGelSequenceIdObj_ || {};
  B("ytLoggingGelSequenceIdObj_", Xg);
  function Yg(a) {
    var b = Zg;
    a = void 0 === a ? z("yt.ads.biscotti.lastId_") || "" : a;
    b = Object.assign($g(b), ah(b));
    b.ca_type = "image";
    a && (b.bid = a);
    return b;
  }
  function $g(a) {
    ...
    b.u_java =
      !!H.navigator &&
      "unknown" !== typeof H.navigator.javaEnabled &&
      !!H.navigator.javaEnabled &&
      H.navigator.javaEnabled();
    H.screen &&
      ((b.u_h = H.screen.height),
      (b.u_w = H.screen.width),
      (b.u_ah = H.screen.availHeight),
      (b.u_aw = H.screen.availWidth),
      (b.u_cd = H.screen.colorDepth));
    H.navigator &&
      H.navigator.plugins &&
      (b.u_nplug = H.navigator.plugins.length);
    H.navigator &&
      H.navigator.mimeTypes &&
      (b.u_nmime = H.navigator.mimeTypes.length);
    return b;
  }
  function ah(a) {
    var b = a.f;
    ...
    try {
      ...
      var m = new oc(l.clientWidth, l.clientHeight).round();
    } catch (n) {
      m = new oc(-12245933, -12245933);
    }
    k = m;
    m = {};
    l = new Nc();
    y.SVGElement && y.document.createElementNS && l.set(0);
    c = Cc();
    c["allow-top-navigation-by-user-activation"] && l.set(1);
    c["allow-popups-to-escape-sandbox"] && l.set(2);
    y.crypto && y.crypto.subtle && l.set(3);
    y.TextDecoder && y.TextEncoder && l.set(4);
    l = Oc(l);
    m.bc = l;
    m.bih = k.height;
    m.biw = k.width;
  ...
  var dh = {
    ...
    eh = "app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(
      " "
    ),
    fh = !1;
  function gh(a, b) {
    ...
    d && e
      ...
      : (c = e
          ? I(c) == e &&
            (Number(c.match(sc)[4] || null) || null) ==
              (Number(a.match(sc)[4] || null) || null)
          : !0);
    d = R("web_ajax_ignore_global_headers_if_set");
    for (var f in dh)
      (e = O(dh[f])),
        !e || (!c && I(a)) || (d && void 0 !== b[f]) || (b[f] = e);
    if (c || !I(a))
    ...
    if (c || !I(a)) b["X-YouTube-Ad-Signals"] = Bf(Yg(void 0));
    return b;
  }
  function hh(a) {
    var b = window.location.search,
      c = I(a),
      d = tc(a.match(sc)[5] || null);
    d =
      (c =
        c &&
  ...
  function ih(a, b) {
    if (window.fetch && "XML" != b.format) {
        ...
        if (!e) {
          ...
          var h = g.ok,
            k = function (l) {
              ...
              var m = b.context || y;
              h
                ? b.onSuccess && b.onSuccess.call(m, l, g)
      ...
      b.ba &&
        0 < b.timeout &&
        (f = zf(function () {
          e || ((e = !0), window.clearTimeout(f), b.ba.call(b.context || y));
        }, b.timeout));
    } else lh(a, b);
  }
  function lh(a, b) {
  ...
  function kh(a, b) {
    ...
    b.Oa ||
      (I(a) && !b.withCredentials && I(a) != document.location.hostname) ||
      "POST" != b.method ||
    ...
    f &&
      ...
      ((e = Cf(e)),
      ub(e, f),
      (e = b.da && "JSON" == b.da ? JSON.stringify(e) : wc(e)));
    if (!(c = e) && (c = f)) {
      a: {
        for (var k in f) {
          f = !1;
    ...
    !fh &&
      c &&
      "POST" != b.method &&
      ((fh = !0), pf(Error("AJAX request with postData should use POST")));
    return e;
  }
  function nh(a, b, c, d) {
    var e = null;
    switch (b) {
      case "JSON":
        ...
        break;
      case "XML":
        if ((a = (a = c.responseXML) ? oh(a) : null))
          (e = {}),
  ...
  function mh(a, b, c, d, e, f, g) {
    function h() {
      4 == (k && "readyState" in k ? k.readyState : 0) && b && of(b)(k);
    }
    c = void 0 === c ? "GET" : c;
    d = void 0 === d ? "" : d;
    var k = ch();
    ...
    R("debug_forward_web_query_parameters") && (a = hh(a));
    k.open(c, a, !0);
    f && (k.responseType = f);
  ...
  function rh() {
    for (
      var a = {}, b = u(Object.entries(Cf(O("DEVICE", "")))), c = b.next();
      !c.done;
      c = b.next()
    ) {
      var d = u(c.value);
  ...
  function sh() {
    return "INNERTUBE_API_KEY" in kf && "INNERTUBE_API_VERSION" in kf;
  }
  function Tg() {
    return {
      innertubeApiKey: O("INNERTUBE_API_KEY", void 0),
      innertubeApiVersion: O("INNERTUBE_API_VERSION", void 0),
      ma: O("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
      na: O("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
      innertubeContextClientVersion: O(
        "INNERTUBE_CONTEXT_CLIENT_VERSION",
        void 0
      ),
      pa: O("INNERTUBE_CONTEXT_HL", void 0),
      oa: O("INNERTUBE_CONTEXT_GL", void 0),
      qa: O("INNERTUBE_HOST_OVERRIDE", void 0) || "",
  ...
  function Sg(a) {
    ...
    a.appInstallData &&
      R("web_log_app_install_experiments") &&
    ...
    b.client = Object.assign(b.client, rh());
    return b;
  }
  function th(a, b, c) {
    c = void 0 === c ? {} : c;
    ...
    (b = c.Ia || O("AUTHORIZATION")) ||
      (a ? (b = "Bearer " + z("gapi.auth.getToken")().Ha) : (b = Mc([])));
    b &&
      ((d.Authorization = b),
  ...
  function vh() {
    var a = new cf();
    (a = a.isAvailable() ? new jf(a, "yt.innertube") : null) ||
      ((a = new df("yt.innertube")), (a = a.isAvailable() ? a : null));
    this.f = a ? new Ze(a) : null;
  ...
  vh.prototype.get = function (a, b) {
    ...
    if (d && (c = nc.get("" + a, void 0)) && ((c = unescape(c)), b))
      try {
        c = JSON.parse(c);
      } catch (e) {
  ...
  vh.prototype.remove = function (a) {
    this.f && this.f.remove(a);
    var b = this.g;
    nc.remove("" + a, "/", void 0 === b ? "youtube.com" : b);
  };
  var wh;
  function xh() {
    wh || (wh = new vh());
  ...
  function yh(a, b, c, d) {
    if (d) return null;
    d = xh().get("nextId", !0) || 1;
    var e = xh().get("requests", !0) || {};
    e[d] = {
      method: a,
      request: b,
      authState: uh(c),
      requestTime: Math.round(Dg()),
    };
    xh().set("nextId", d + 1, 86400, !0);
    xh().set("requests", e, 86400, !0);
    return d;
  }
  function zh(a) {
    var b = xh().get("requests", !0) || {};
    delete b[a];
    xh().set("requests", b, 86400, !0);
  }
  function Ah(a) {
    var b = xh().get("requests", !0);
    if (b) {
      for (var c in b) {
        var d = b[c];
        if (!(6e4 > Math.round(Dg()) - d.requestTime)) {
          var e = d.authState,
            f = uh(th(!1));
          rb(e, f) &&
            ((e = d.request),
            "requestTimeMs" in e && (e.requestTimeMs = Math.round(Dg())),
            Wg(a, d.method, e, {}));
          delete b[c];
        }
      }
  ...
  U.all = function (a) {
    return new U(function (b, c) {
      var d = [],
        e = a.length;
      0 === e && b(d);
      for (var f = { D: 0 }; f.D < a.length; f = { D: f.D }, ++f.D)
        Gh(
          U.resolve(a[f.D]).then(
            (function (g) {
              return function (h) {
                d[g.D] = h;
                e--;
  ...
  U.prototype.then = function (a, b) {
    var c = this,
      d = null !== a && void 0 !== a ? a : Fh,
      e = null !== b && void 0 !== b ? b : Eh;
    return new U(function (f, g) {
      "PENDING" === c.state.status
        ...
        ? Hh(c, c, d, f, g)
        : "REJECTED" === c.state.status && Ih(c, c, e, f, g);
    });
  };
  function Gh(a, b) {
    a.then(void 0, b);
  ...
  function Hh(a, b, c, d, e) {
    try {
      ...
      f instanceof U ? Jh(a, b, f, d, e) : d(f);
    } catch (g) {
      e(g);
    }
  }
  ...
  var Ph = {},
    Qh =
      ((Ph.AUTH_INVALID = "No user identifier specified."),
      (Ph.EXPLICIT_ABORT = "Transaction was explicitly aborted."),
      (Ph.IDB_NOT_SUPPORTED = "IndexedDB is not supported."),
      (Ph.MISSING_OBJECT_STORE = "Object store not created."),
      (Ph.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons."),
      (Ph.QUOTA_EXCEEDED =
        "The current transaction exceeded its quota limitations."),
      (Ph.QUOTA_MAYBE_EXCEEDED =
  ...
  function Rh(a, b, c) {
    ...
    this.type = a;
    this.message = c;
    Object.setPrototypeOf(this, Rh.prototype);
  }
  qa(Rh, Nh);
  function Sh(a, b) {
    Rh.call(this, "UNKNOWN_ABORT", { objectStoreNames: a.join(), dbName: b });
  ...
  p.add = function (a, b, c) {
    return Uh(this, [a], "readwrite", function (d) {
      return Vh(d, a).add(b, c);
    });
  };
  p.clear = function (a) {
    return Uh(this, [a], "readwrite", function (b) {
      return Vh(b, a).clear();
    });
  };
  p.close = function () {
  ...
  p.count = function (a, b) {
    return Uh(this, [a], "readonly", function (c) {
      return Vh(c, a).count(b);
    });
  };
  p["delete"] = function (a, b) {
    return Uh(this, [a], "readwrite", function (c) {
      return Vh(c, a)["delete"](b);
    });
  };
  p.get = function (a, b) {
    return Uh(this, [a], "readwrite", function (c) {
  ...
  p["delete"] = function (a) {
    return a instanceof IDBKeyRange ? Zh(this, a) : V(this.f["delete"](a));
  };
  p.get = function (a) {
    return V(this.f.get(a));
  };
  p.index = function (a) {
    return new bi(this.f.index(a));
  };
  p.getName = function () {
    return this.f.name;
  };
  function $h(a, b, c) {
    a = a.f.openCursor(b.query, b.direction);
      ...
      b.f.addEventListener("abort", function () {
        ...
        if (e) {
          ...
          "QuotaExceededError" === e.name
            ? (f = new Rh("QUOTA_EXCEEDED"))
            : "UnknownError" === e.name && (f = new Rh("QUOTA_MAYBE_EXCEEDED"));
          f &&
            (qf(f),
            Oh.push({
              type: "EVENT",
            ...
            10 < Oh.length && Oh.shift());
          d(e);
        } else if (!b.aborted) {
          e = Sh;
          f = b.f.objectStoreNames;
  ...
  function Xh(a, b) {
    ...
    return Ee([c, a.done]).then(function (d) {
  ...
  function Vh(a, b) {
    var c = a.f.objectStore(b),
      d = a.g.get(c);
    d || ((d = new Yh(c)), a.g.set(c, d));
    return d;
  }
  function bi(a) {
    this.f = a;
  }
  bi.prototype.count = function (a) {
    return V(this.f.count(a));
  };
  ...
  ci.prototype.update = function (a) {
    return V(this.f.update(a));
  };
  function He(a) {
    function b() {
      m || (m = new c(e.result, { closed: l }));
      return m;
    }
    var c = Th,
      d = Wh,
      e = self.indexedDB.open("yt-idb-test-do-not-use", void 0),
      f = a.blocked,
      g = a.blocking,
      h = a.Sa,
      k = a.upgrade,
      ...
      m;
    k &&
      e.addEventListener("upgradeneeded", function (n) {
        ...
        var r = b(),
          q = new d(e.transaction);
        k(r, n.oldVersion, n.newVersion, q);
      });
    f &&
      e.addEventListener("blocked", function () {
        f();
      });
    return Lh(e).then(function (n) {
      g &&
  ...
  var di,
    ei,
    fi = ["getAll", "getAllKeys", "getKey", "openKeyCursor"],
    gi = ["getAll", "getAllKeys", "getKey", "openKeyCursor"];
  function hi() {
    return $a(this, function b() {
      var c, d;
      return Ia(b, function (e) {
        switch (e.g) {
          case 1:
            if (
              (Bh &&
                Ch() &&
                !Dh() &&
                !R("ytidb_allow_on_ios_safari_v8_and_v9")) ||
              Lb
            )
              return e["return"](!1);
            try {
  ...
  function pi(a, b) {
    ...
    qi().then(function () {
      ki.f || (ki.f = new ki());
      ki.f.g !== li() &&
        pf(Error("NetworkStatusManager isOnline does not match window status"));
      lh(a, b);
    });
  }
  function qi() {
    return $a(this, function b() {
      return Ia(b, function (c) {
        return R("networkless_logging")
          ? (2 === vg("networkless_ytidb_version") &&
              ji().then(function (d) {
                return d;
              }),
            c["return"](ii()))
  ...
  function ri(a) {
    var b = this;
    this.f = null;
    a ? (this.f = a) : sh() && (this.f = Tg());
    xg(function () {
      Ah(b);
    });
  }
  ri.prototype.isReady = function () {
    !this.f && sh() && (this.f = Tg());
    return !!this.f;
  };
  function Wg(a, b, c, d) {
    !O("VISITOR_DATA") &&
      ...
      0.01 > Math.random() &&
      qf(
        new Nh("Missing VISITOR_DATA when sending innertube request.", b, c, d)
      );
    if (!a.isReady()) {
      var e = new Nh("innertube xhrclient not ready", b, c, d);
      pf(e);
      e.sampleWeight = 0;
      throw e;
    }
    ...
    var l = { alt: "json" };
    (a.f.ra && f.headers.Authorization) || (l.key = a.f.innertubeApiKey);
    var m = ig("" + g + e, l || {}, !0);
    qi().then(function (n) {
      if (
        d.retry &&
        R("retry_web_logging_batches") &&
      ...
      try {
        R("use_fetch_for_op_xhr")
          ? ih(m, f)
          : R("networkless_gel") && d.retry
          ? ((f.method = "POST"), oi(m, f))
          : ((f.method = "POST"), f.u || (f.u = {}), lh(m, f));
      } catch (w) {
        if ("InvalidAccessError" == w.name)
          r && (zh(r), (r = 0)),
            qf(Error("An extension is blocking network request."));
        else throw w;
      }
      r &&
        xg(function () {
  ...
  var wi = new Set(),
    xi = 0,
    yi = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
  function zi(a, b, c, d) {
    c += "." + a;
  ...
  function W(a, b, c) {
    ...
    if ((a = "string" === typeof a ? c.getElementById(a) : a))
      if (
        ...
        b.host || (b.host = c ? uc(a.src) : "https://www.youtube.com"),
        (this.g = new rg(b)),
        c ||
          ((b = Ai(this, a)),
          (this.l = a),
          ...
          (a = b)),
        (this.f = a),
        this.f.id || (this.f.id = "widget" + Ra(this.f)),
        (lg[this.f.id] = this),
        window.postMessage)
      ) {
        this.i = new M();
  ...
  function Ai(a, b) {
      ...
      D(["debugjs", "debugcss"], function (k) {
        ...
        b: {
          ...
          for (var r = k.length; 0 <= (n = l.indexOf(k, n)) && n < m; ) {
            ...
            if (38 == q || 63 == q)
              if (
                ((q = l.charCodeAt(n + r)), !q || 61 == q || 38 == q || 35 == q)
              )
                break b;
            n += r + 1;
          }
    ...
    c.src = Q(a.g, "host") + a.R() + "?" + wc(h);
    return c;
  }
  p.ca = function () {
    this.f && this.f.contentWindow
      ? this.V({ event: "listening" })
  ...
  function Bi(a) {
    ...
    yf(
      ...
      Xa(function () {
        window.clearInterval(this.h);
        this.h = Af(Xa(this.ca, this));
      }, a)
    );
  }
  function Di(a, b) {
    a.G[b] || ((a.G[b] = !0), Ei(a, "addEventListener", [b]));
  }
  p.V = function (a) {
    a.id = this.j;
    a.channel = "widget";
      ...
      for (var f = 0; f < e.length; f++)
        try {
          ...
          if (Ka.name && "SyntaxError" == Ka.name) {
            if (!(Ka.message && 0 < Ka.message.indexOf("target origin ''"))) {
              var g = void 0,
                h = void 0,
                k = Ka;
              h = void 0 === h ? {} : h;
              h.name = O("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
              h.version = O("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0);
              var l = h || {},
                m = "WARNING";
              m = void 0 === m ? "ERROR" : m;
              g = void 0 === g ? !1 : g;
              if (k) {
                if (R("console_log_js_exceptions")) {
                  ...
                  n.hasOwnProperty("params") &&
                    r.push("Error Params: " + JSON.stringify(n.params));
                  r.push("File name: " + n.fileName);
                  r.push("Stacktrace: " + n.stack);
                  window.console.log(r.join("\n"), n);
                }
                if (
                  ((window && window.yterr) || g) &&
                  !(5 <= xi) &&
                  0 !== k.sampleWeight
                ) {
                  var q = void 0,
                    ...
                    w = l,
                    E = ic(v),
                    Sa = E.message || "Unknown Error",
                    fa = E.name || "UnknownError",
                    Da = E.lineNumber || "Not available",
                    Ki = E.fileName || "Not available",
                    Li = E.stack || v.f || "Not available";
                  if (v.hasOwnProperty("args") && v.args && v.args.length)
                    for (var na = 0, Sb = 0; Sb < v.args.length; Sb++) {
                      var N = v.args[Sb],
                        za = "params." + Sb;
                      na += za.length;
                      if (N)
                        if (Array.isArray(N)) {
                          for (
                            ...
                            hb < N.length &&
                            !(
                              N[hb] && ((cd += zi(hb, N[hb], za, Mi)), 500 < cd)
                            );
                            hb++
                          );
                          na = cd;
                          ...
                          for (Tb in N)
                            if (
                              N[Tb] &&
                              ((dd += zi(Tb, N[Tb], za, Ni)), 500 < dd)
                            )
                              break;
                          na = dd;
                        } else
                          (w[za] = String(JSON.stringify(N)).substring(0, 500)),
                            (na += w[za].length);
                      else
                        (w[za] = String(JSON.stringify(N)).substring(0, 500)),
                          (na += w[za].length);
                    ...
                    if ("object" === typeof v.params) {
                      ...
                      for (q in Ub)
                        if (Ub[q]) {
                          var Ef = "params." + q,
                            Ff = String(JSON.stringify(Ub[q])).substr(0, 500);
                          w[Ef] = Ff;
                          Df += Ef.length + Ff.length;
                          if (500 < Df) break;
                        }
                    } else w.params = String(JSON.stringify(Ub)).substr(0, 500);
                  }
                  navigator.vendor &&
                    !w.hasOwnProperty("vendor") &&
                    (w.vendor = navigator.vendor);
                  var ed = {
                      message: Sa,
                      name: fa,
                      lineNumber: Da,
                    ...
                    Gf = Number(v.columnNumber);
                  isNaN(Gf) || (ed.lineNumber = ed.lineNumber + ":" + Gf);
                  for (
                    var Y, Aa = ed, Hf = u(si), fd = Hf.next();
                    !fd.done;
                    fd = Hf.next()
                  ) {
                    var gd = fd.value;
                    if (gd.U[Aa.name])
                      for (
                        var If = u(gd.U[Aa.name]), hd = If.next();
                        !hd.done;
                        hd = If.next()
                      ) {
                        var Jf = hd.value,
                          Vb = Aa.message.match(Jf.regexp);
                        if (Vb) {
                          Aa.params["error.original"] = Vb[0];
                          for (
                            var id = Jf.groups, Kf = {}, La = 0;
                            La < id.length;
                            La++
                          )
                            (Kf[id[La]] = Vb[La + 1]),
                              (Aa.params["error." + id[La]] = Vb[La + 1]);
                          Aa.message = gd.Z(Kf);
                          break;
                        }
                      }
                  ...
                  if (
                    !(
                      wi.has(Y.message) ||
                      0 <= Y.stack.indexOf("/YouTubeCenter.js") ||
                      0 <= Y.stack.indexOf("/mytube.js")
                    )
                  ) {
                    vi.M("handleError", Y);
                    if (R("kevlar_gel_error_routing")) {
                      ...
                      a: {
                        for (
                          ...
                          if (
                            Nf &&
                            0 <=
                              Nf.toLowerCase().indexOf(jd.value.toLowerCase())
                          ) {
                            var Of = !0;
                            break a;
                          }
                      ...
                      if (!Of) {
                        var ib = { stackTrace: L.stack };
                        L.fileName && (ib.filename = L.fileName);
                        var Z =
                          L.lineNumber && L.lineNumber.split
                            ? L.lineNumber.split(":")
                            : [];
                        0 !== Z.length &&
                          (1 !== Z.length || isNaN(Number(Z[0]))
                            ? 2 !== Z.length ||
                              isNaN(Number(Z[0])) ||
                              isNaN(Number(Z[1])) ||
                              ((ib.lineNumber = Number(Z[0])),
                              (ib.columnNumber = Number(Z[1])))
                            : (ib.lineNumber = Number(Z[0])));
                        var Oi = L.message,
                          Pi = L.name;
                        ui || (ui = new ti());
                        ...
                        a: {
                          for (
                            var Qf = u(Pf.g), kd = Qf.next();
                            !kd.done;
                            kd = Qf.next()
                          ) {
                            var Rf = kd.value;
                            if (L.message && L.message.match(Rf.f)) {
                              var ld = Rf.weight;
                              break a;
                            }
                          }
                          for (
                            var Sf = u(Pf.f), md = Sf.next();
                            !md.done;
                            md = Sf.next()
                          ) {
                            var Tf = md.value;
                        ...
                        "ERROR" === Lf
                          ? (nd.level = "ERROR_LEVEL_ERROR")
                          : "WARNING" === Lf &&
                            (nd.level = "ERROR_LEVEL_WARNNING");
                        var Qi = { isObfuscated: !0, browserStackInfo: ib },
                          Ma = { pageUrl: window.location.href };
                        O("FEXP_EXPERIMENTS") &&
                          (Ma.experimentIds = O("FEXP_EXPERIMENTS"));
                        Ma.kvPairs = [];
                        var od = L.params;
                        if (od)
                          for (
                            var Uf = u(Object.keys(od)), pd = Uf.next();
                            !pd.done;
                            pd = Uf.next()
                          ) {
                            var Vf = pd.value;
                        ...
                        var Wf = O("SERVER_NAME", void 0),
                          Xf = O("SERVER_VERSION", void 0);
                        Wf &&
                          Xf &&
                          (Ma.kvPairs.push({ key: "server.name", value: Wf }),
                          Ma.kvPairs.push({
                            key: "server.version",
                            value: Xf,
                          }));
                        ...
                        Wb = void 0 === Wb ? {} : Wb;
                        var Yf = ri;
                        O("ytLoggingEventsDefaultDisabled", !1) &&
                          ri == ri &&
                          (Yf = null);
                        var Si = Yf,
                          T = Wb;
                        T = void 0 === T ? {} : T;
                        var jb = {};
                        jb.eventTimeMs = Math.round(T.timestamp || Dg());
                        jb.clientError = Ri;
                        var Ti = String;
                        if (T.timestamp) var Zf = -1;
                        else {
                          var $f = z("_lact", window);
                          Zf = null == $f ? -1 : Math.max(Date.now() - $f, 0);
                        }
                        jb.context = { lastActivityMs: Ti(Zf) };
                        if (R("log_sequence_info_on_gel_web") && T.fa) {
                          var Ui = jb.context,
                            kb = T.fa;
                          Xg[kb] = kb in Xg ? Xg[kb] + 1 : 0;
                          Ui.sequence = { index: Xg[kb], groupKey: kb };
                          T.Na && delete Xg[T.fa];
                        }
                        var Vi = jb,
                          Xb = T.Ma,
                        ...
                        if (Xb) {
                          var Yb = Xb,
                            rd = {};
                          Yb.videoId
                            ? (rd.videoId = Yb.videoId)
                            : Yb.playlistId && (rd.playlistId = Yb.playlistId);
                          Og[Xb.token] = rd;
                          qd = Xb.token;
                        }
                        var sd = Ng.get(qd) || [];
                        ...
                        sd.push(Vi);
                        ag && (Ig = new ag());
                        var Wi = vg("web_logging_max_batch") || 100,
                          bg = Dg();
                        sd.length >= Wi
                          ? Pg()
                          : 10 <= bg - Lg && (Rg(), (Lg = bg));
                    ...
                    if (!R("suppress_error_204_logging")) {
                      ...
                      lb.version && (oa["client.version"] = lb.version);
                      if (oa.u) {
                        Ba.stack && (oa.u.stack = Ba.stack);
                        for (
                          var cg = u(Object.keys(lb)), ud = cg.next();
                          !ud.done;
                          ud = cg.next()
                        ) {
                          var dg = ud.value;
                          oa.u["client." + dg] = lb[dg];
                        }
                        if (
                          (td = O(
                          ...
                          for (
                            var eg = u(Object.keys(td)), vd = eg.next();
                            !vd.done;
                            vd = eg.next()
                          ) {
                            var fg = vd.value;
                        ...
                        var gg = O("SERVER_NAME", void 0),
                          hg = O("SERVER_VERSION", void 0);
                        gg &&
                          hg &&
                          ((oa.u["server.name"] = gg),
                          (oa.u["server.version"] = hg));
                      }
                      lh(O("ECATCHER_REPORT_HOST", "") + "/error_204", oa);
                    }
                    wi.add(Y.message);
                    xi++;
                  }
  ...
  p.ea = function (a) {
    ...
    switch (b) {
      case "apiInfoDelivery":
        if (A(a)) for (var c in a) this.C[c] = a[c];
        break;
      case "infoDelivery":
        Hi(this, a);
        break;
  ...
  function Hi(a, b) {
    if (A(b)) for (var c in b) a.playerInfo[c] = b[c];
  }
  function Ii(a, b) {
    D(
      b,
  ...
  function Ji(a) {
    if ("iframe" != a.tagName.toLowerCase()) {
      var b = P(a, "videoid");
      b &&
        ((b = { videoId: b, width: P(a, "width"), height: P(a, "height") }),
        new X(a, b));
    }
  }
  function Xi(a, b) {
  ...
  Xi.prototype.N = function (a, b) {
    W.prototype.N.call(this, a, b ? b.info : void 0);
  };
  function Yi(a) {
    if ("iframe" != a.tagName.toLowerCase()) {
      var b = P(a, "videoid");
  ...
  W.prototype.getIframe = W.prototype.ta;
  ...
  var Zi = y.onYTReady;
  Zi && Zi();
  var $i = y.onYouTubeIframeAPIReady;
  $i && $i();
  var aj = y.onYouTubePlayerAPIReady;
  aj && aj();
}.call(this));
