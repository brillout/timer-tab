...
const ad_slots = [
  ...
  */
  ...
  },
  {
    ...
    product_text:
      "Best Egg Timer out there: no BPA, reliable, simple, and beautiful.",
    amazon_banner: `
    ...
    `,
    product_link:
      "https://www.amazon.com/NobleEgg-Timer-Boiled-Changes-Certified/dp/B07V7XG4Q9/ref=as_li_ss_tl?ie=UTF8&linkCode=ll1&tag=brilloutamazo-20&linkId=d844caeabfd4afe21a706d975fea8e1a",
    is_product: true,
  },
  {
    product_name: "product-tablet-monitor",
    product_text:
      "Tablet monitor, to put Timer Tab on! No-name brand but the monitor is well designed.",
    amazon_banner: `
  ...
  {
    product_name: "product-visual-timer",
    product_text:
      "Well designed Visual Timer. Unlike most other Visual Timers, this one is robust.",
    amazon_banner: `
      <a href="https://www.amazon.com/Secura-60-Minute-Mechanical-Countdown-Collapsible/dp/B07PKTNYWQ/ref=as_li_ss_il?ie=UTF8&linkCode=li3&tag=brilloutamazo-20&linkId=030d640867216cf075f275ed343fdc15" target="_blank"><img border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&ASIN=B07PKTNYWQ&Format=_SL250_&ID=AsinImage&MarketPlace=US&ServiceVersion=20070822&WS=1&tag=brilloutamazo-20" ></a><img src="https://ir-na.amazon-adsystem.com/e/ir?t=brilloutamazo-20&l=li3&o=1&a=B07PKTNYWQ" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important;" />
    `,
    product_link:
